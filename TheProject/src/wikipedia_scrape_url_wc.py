...
artist_df = pd.read_csv('../CSE519-2017-111634527/TheProject/music_data/billboard_artist_name.csv', na_values=['NA'])
...
artist_df.to_csv('billboard_artist.csv', sep=',', index=False)